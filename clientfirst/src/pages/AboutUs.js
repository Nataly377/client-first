...
<div className="navbar">
        <div className="container">
            ...
            <div className="arow">
                <p className="me-2">Clone Project</p>
                <img src="img/Arrow 6.png" alt="arow" className="ar" />
            </div>
        </div>
    </div>
 ...
 <div className="image-section d-flex justify-content-between">
    <div>
      <img src="img/about (1).jpg" alt="relaxtime" className="slika1 me-5" />
    </div>
  <div>
...
<div className="aboutimage container">
  <div className="cafee">
    <h2 className="mt-4">One of the best 
...
<div className="history container mb-5" />
 ...
 <div className="me-3"> 
    ...
    <h3>1998</h3>
    <h4 className="py-2">Milestone One</h4>
    <p className="py-2">Through True Rich Attended does no end it his mother since favourable.</p>
 </div>
 <div className="me-3" />
     <img src="img/aboutLinee (2).png" />
     <img src="img/aboutLine (2).png" style={{width: '100%'}} />
     <h3>2005</h3>
     <h4 className="py-2">Milestone Two</h4>
     <p className="py-2">Through True Rich Attended does no end it his mother since favourable.</p>
 <div className="me-3"> 
     <img src="img/aboutLinee (2).png" />
     <img src="img/aboutLine (2).png" style={{width: '100%'}} />
     <h3>2012</h3>
     <h4 className="py-2">Milestone Three</h4>
     <p className="py-2">Through True Rich Attended does no end it his mother since favourable.</p>
 </div>
 <div className="me-3"> 
     <img src="img/aboutLinee (2).png" />
     <img src="img/aboutLine (2).png" style={{width: '100%'}} />
     <h3>2021</h3>
     <h4 className="py-2">Milestone Four</h4>
    <p className="py-2">Through True Rich Attended does no end it his mother since favourable.</p>
 </div>

<div className="abouttext container d-flex justify-content-between">
   <div>
       <h3>Things our company
        stands for</h3>
   </div>
   <div className="abouttext2">
    <h3 className="mb-4">Edit this text to make it your own. To edit, simply click directly</h3>
...
<div className="contact container d-md-flex">
  ...
  <div>
   ...
   <footer className="footer container me-5" >
    <img src="img/Logo.svg" alt="logo" />
  <div className="footer-link mb-5 mt-5">
    <a href="/">Home</a>
    <a href="Menu">Menu</a>
    <a href="AboutUs">About Us</a>
    <a href="OurStory">OurStory</a>
...
<hr />
  <div className="foot d-flex justify-content-between container ms-3">
    <div>
        <p>© 2021 Finsweet | All rights reserved.</p>
    </div>
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
      className="bi bi-facebook me-3" viewBox="0 0 16 16">
      <path
      d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" />
      </svg>

      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
      className="bi bi-twitter me-3" viewBox="0 0 16 16">
      <path
      d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334q.002-.211-.006-.422A6.7 6.7 0 0 0 16 3.542a6.7 6.7 0 0 1-1.889.518 3.3 3.3 0 0 0 1.447-1.817 6.5 6.5 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.32 9.32 0 0 1-6.767-3.429 3.29 3.29 0 0 0 1.018 4.382A3.3 3.3 0 0 1 .64 6.575v.045a3.29 3.29 0 0 0 2.632 3.218 3.2 3.2 0 0 1-.865.115 3 3 0 0 1-.614-.057 3.28 3.28 0 0 0 3.067 2.277A6.6 6.6 0 0 1 .78 13.58a6 6 0 0 1-.78-.045A9.34 9.34 0 0 0 5.026 15" />
      </svg>

      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
      className="bi bi-instagram me-3" viewBox="0 0 16 16">
      <path
      ...
      <div>
      <p className="slikaf ">Contact Us <img src="img/Arrow 6.png" /></p>
    </div>
  </div>
</footer>
</>
