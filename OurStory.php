...
<div class="navbar">
    ...
    <div class="ourStory container d-flex justify-content-between">
        <div class="ourstory-naslov">
            <h1>Our Story</h1>
            <p class="paragos">Through True Rich Attended does no end it his mother since 
            favourable real had half every him case in packages enquire we 
            up ecstatic.</p>
          <div class="osimg d-flex justify-content-between">  
            <img src="img/osimg.jpg" alt="wiewoutside" class="me-4 mt-5" style="width: 100%;">
            <img src="img/osimg2.jpg" alt="wiew" style="width: 100%;" class="ms-3">
           <div> 
        </div>
        <div class="textos mb-5">
            <h3 class="mb-3">One of the best cafes in New York.</h3>
